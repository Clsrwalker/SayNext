...
export const PROJECT_PROFILE_IMMEDIATE_RULES: ImmediateRule[] = [
  ...
  },
  {
    ...
    hint: "Route as a cloud-project experience answer. Use project facts as grounding, but let the model phrase the final response naturally.",
    mustInclude: ["JobLens AI", "ElderAlbum", "Lambda"],
    mustAvoid: ["Hybrid Search", "I should use"],
  ...
  },
  {
    ...
    hint: "Route as Xiang's programming-language experience. Keep it honest about stronger current languages versus older/rustier ones.",
    mustInclude: ["TypeScript", "JavaScript", "C++", "Java", "Python", "React Native", "databases", "rusty"],
  ...
  },
  {
    ...
    hint: "Treat java script as an ASR-safe JavaScript clarification, not a finance or policy term.",
    mustInclude: ["JavaScript", "programming language"],
    mustAvoid: ["inflation", "hawkish", "dovish", "rates"],
  ...
  },
  {
    ...
    hint: "Route as a DalParkAid privacy/data-plan answer. Keep the answer aggregate and avoid implying personal route tracking.",
    mustInclude: ["aggregate", "location history"],
